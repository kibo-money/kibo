 ...
 */
export interface CustomData<HorzScaleItem = Time>
  extends CustomSeriesWhitespaceData<HorzScaleItem> {
  /**
 ...
 */
export type CreatePriceLineOptions = Partial<PriceLineOptions> &
 ...
 * Represents the type of data that a series contains.
 */
export type DataItem<HorzScaleItem> =
  SeriesDataItemTypeMap<HorzScaleItem>[SeriesType];
/**
 ...
 */
export type HorzScaleItemConverterToInternalObj<HorzScaleItem> = (
  time: HorzScaleItem
 ...
 */
export type TimeFormatterFn<HorzScaleItem = Time> = (
  time: HorzScaleItem
) => string;
/**
